    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex shrink-0 items-center">
          <i class="fa-solid fa-motorcycle" style="color: #ffffff;" class="h-8 w-auto"></i>
        </div>
      ...
      <a href="/admin/form" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white">+ Tambah Motor</a>
        ...
        <div class="relative ml-3 flex">
          <i class="fab fa-whatsapp text-xl" style="color: #ffffff;" class="h-8 w-auto"></i>
            <h2 class="text-white ml-3">Chat Ki Baher</h2>
</div>

  <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
    <div class="space-y-1 px-2 pt-2 pb-3">
      <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
      <a href="/" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Beli Motor</a>
